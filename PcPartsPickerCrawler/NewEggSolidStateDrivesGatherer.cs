...
{
    public class NewEggSolidStateDrivesGatherer
    {

        public async Task<IEnumerable<SolidStateDrive>> GatherSolidStateDrivesData()
        {
            var videoCards = new List<SolidStateDrive>();
            ...
            for (int page = 1; page <= 100; page++)
            {
                ...
                var url = $"https://www.newegg.com/Desktop-Memory/SubCategory/ID-636/Page-{page}";
                    ...
                    if (spec.Contains("<dt>") && spec.Contains("<dd>"))
                    {
                        ...
                        switch (specName)
                        {
                            ...
                            case "Capacity":
                                ...
                                break;
                            case "Device Type":
                                videoCard.DeviceType = specValue;
                                break;
                            case "Used For":
                                videoCard.UsedFor = specValue;
                                break;
                            case "Memory Components":
                                videoCard.MemoryComponents = specValue;
                                break;
                            case "FormFactor":
